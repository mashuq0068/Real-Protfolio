...
const Projects = () => {
  ...
  useEffect(() => {
    ...
    return (
      ...
      <div className="bg-yellow-50  flex justify-center items-center h-screen w-full">
        {/* all projects div */}
        <div className="grid grid-cols-3 ani-right  gap-[10%]">
          {/* first project */}
        <div onMouseLeave={()=>{setHoverProjectOne(false)}} onMouseEnter={()=>{setHoverProjectOne(true)}} className=" cursor-pointer  w-[20vw] relative shadow-lg shadow-black">
         <div className=" ">
         <img className="h-[30vh] w-max mx-auto " src="https://i.ibb.co/yfdXV9Y/depositphotos-200340872-stock-photo-attractive-young-male-female-models-removebg-preview.png" alt="" />
          ...
          <div className={`${hoverProjectOne ? "block ani-hover" : "hidden" } bg-amber-950 flex flex-col gap-[6%] justify-center items-center absolute top-0 h-full w-full`}>
          ...
          {/* first project */}
        <div onMouseLeave={()=>{setHoverProjectTwo(false)}} onMouseEnter={()=>{setHoverProjectTwo(true)}} className=" w-[20vw] cursor-pointer relative  shadow-lg shadow-black">
         <div className="  ">
         ...
         <img className="h-[30vh] pb-[3vh] pt-[2vh] w-max mx-auto " src="https://i.ibb.co/kqZk0Db/Screenshot-2023-12-08-000550.png" alt="" />
          ...
          <div className={`${hoverProjectTwo? "block ani-hover" : "hidden" } bg-amber-950 flex flex-col gap-[6%] justify-center items-center absolute top-0 h-full w-full`}>
          ...
          {/* first project */}
        <div onMouseLeave={()=>{setHoverProjectThree(false)}} onMouseEnter={()=>{setHoverProjectThree(true)}} className="w-[20vw] cursor-pointer  relative  shadow-lg shadow-black">
         <div className=" ">
         <img className="h-[30vh] w-max mx-auto " src="https://i.ibb.co/4VjXd7n/Screenshot-2023-12-08-001829.png" alt="" />
          ...
          <div className={`${hoverProjectThree ? "block ani-hover" : "hidden" } bg-amber-950 flex flex-col gap-[6%] justify-center items-center absolute top-0 h-full w-full`}>
            <a href="https://brand-shop-fd7b2.web.app" className="2xl:text-xl lg:text-lg text-white px-6 py-2 rounded-3xl drop-shadow-xl shadow-xl bg-black">Go Live</a>
            <a href="https://github.com/mashuq0068/life-puls-client" className="2xl:text-xl lg:text-lg text-white px-6 py-2 rounded-3xl drop-shadow-xl shadow-xl bg-black">Github</a>
