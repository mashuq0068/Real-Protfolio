...
const Root = () => {
    return (
        ...
        <div className="ani-root h-[100vh] lg:flex hidden flex-col xl:text-[18px] gap-5 2xl:text-2xl text-base   w-[30vw] items-start pl-[3vw] relative font-notify  bg-slate-200 drop-shadow-xl shadow-xl shadow-black   ">
