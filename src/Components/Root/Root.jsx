...
const Root = () => {
    return (
        ...
        <div className="myAni2 h-[100vh] lg:flex hidden flex-col xl:text-xl gap-5 2xl:text-2xl   w-[30vw] items-start pl-[3vw] relative font-notify  bg-slate-200 drop-shadow-xl shadow-xl shadow-black   ">
