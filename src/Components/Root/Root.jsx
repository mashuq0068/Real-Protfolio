...
const Root = () => {
    return (
        ...
        <div className="myAni2 lg:flex hidden flex-col xl:text-xl gap-5 2xl:text-2xl   w-[30vw] items-start pl-[3vw] relative font-notify  bg-slate-200 drop-shadow-xl shadow-xl shadow-black   ">
           ...
           <NavLink className=' animate-bounce focus:pl-3 focus:animate-none focus:pr-[70%]  duration-1000 focus:bg-cyan-400  hover:bg-cyan-400 focus:py-2 focus:rounded-2xl hover:pl-3 hover:pr-[70%] hover:py-2 hover:rounded-2xl hover:animate-none' to='/'>Projects</NavLink>
           <NavLink className=' animate-bounce focus:pl-3 focus:animate-none focus:pr-[20vw]   duration-1000 focus:bg-amber-400  hover:bg-amber-400 focus:py-2 focus:rounded-2xl hover:pl-3 hover:pr-[20vw] hover:py-2 hover:rounded-2xl hover:animate-none' to='/'>Skills</NavLink>
