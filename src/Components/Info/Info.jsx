...
const Info = () => {
  ...
  console.log(customCursorPosition)
    ...
    <div className="flex-col flex items-center   h-screen justify-center  ">
        <div className="relative ani-left  text-2xl lg:pt-[0] pt-[10vh] z-20 xl:text-2xl   2xl:text-3xl p-[2%]  top-5 " >
           <h2 className="lg:pb-0 pb-[5vh]">About me</h2>
        </div>
        <div  className="ani-right   2xl:w-[40vw] z-10 xl:w-[55vw] p-[3%] lg:pl-[3%] xl:text-lg  lg:h-[70vh] 2xl:text-2xl ">
