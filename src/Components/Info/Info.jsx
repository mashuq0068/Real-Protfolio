...
const Info = () => {
  ...
  console.log(customCursorPosition)
    ...
    <div className="flex-col flex items-center   h-screen justify-center pb-[5%]  ">
        ...
        <div  className="ani-right   2xl:w-[40vw] z-10 xl:w-[55vw] p-[3%] lg:pl-[3%] xl:text-xl  lg:h-[70vh] 2xl:text-2xl ">
            <p onMouseLeave={()=>{setCursorWidth("w-[40px] h-[40px] border border-black  bg-transparent")}}    onMouseOverCapture={()=>{{setCursorWidth("w-[150px] duration-1000 border-none bg-red-500 text-white h-[150px]")}}} className=" text-center  ani-letter    font-medium
              ">
